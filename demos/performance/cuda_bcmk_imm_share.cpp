...
int main() {
  ...
  TimingResult kernelGenTR = kernelGenTimer.timeit([&]() {
    ...
    localKM.genCUDAGatesFromlegacy::CircuitGraphMulti(genConfig, *graphPtr, "testCircuit");
  });
  ...
  kernelMgr.genCUDAGatesFromlegacy::CircuitGraphMulti(genConfig, *graphPtr, "testCircuit");
