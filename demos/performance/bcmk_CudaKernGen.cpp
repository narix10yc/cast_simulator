...
// Measure how long genCUDAGatesFromlegacy::CircuitGraph(...) takes
double
measureKernelGenerationTime(const cast::legacy::CircuitGraph& graph,
                            int blockSize,
...
int main() {
  ...
  std::vector<PrecisionMode> precisions = {PrecisionMode::Float32,
