...
int main() {
  ...
  // Build the real LegacyCircuitGraph
  ...
  TimingResult kernelGenTR = kernelGenTimer.timeit([&]() {
    ...
    localKM.genCUDAGatesFromLegacyCircuitGraphMulti(genConfig, *graphPtr, "testCircuit");
  });
  ...
  kernelMgr.genCUDAGatesFromLegacyCircuitGraphMulti(genConfig, *graphPtr, "testCircuit");
