...
std::string Node::_getKindName(Node::NodeKind k) {
  ...
  case NK_Stmt_GateChain:
    return "GateChainStmt";
  case NK_Stmt_GateBlock:
    return "GateBlockStmt";
  case NK_Stmt_Measure:
    return "MeasureStmt";
  case NK_Stmt_If:
    return "IfStmt";
  case NK_Stmt_Out:
  ...
  case NK_Stmt_Repeat:
    return "RepeatStmt";
  case NK_Stmt_Circuit:
    return "CircuitStmt";
  case NK_Stmt_PauliComponent:
    return "PauliComponentStmt";
  case NK_Stmt_Channel:
    return "ChannelStmt";
  case NK_Expr_Identifier:
    return "IdentifierExpr";
  case NK_Expr_ParameterDecl:
    return "ParameterDeclExpr";
  case NK_Expr_Call:
    return "CallExpr";
  case NK_Expr_SimpleNumeric:
    return "SimpleNumericExpr";
  case NK_Expr_IntegerLiteral:
    return "IntegerLiteral";
  case NK_Expr_FloatingLiteral:
    return "FloatingLiteral";
  case NK_Expr_FractionLiteral:
    return "FractionLiteral";
  case NK_Expr_FractionPiLiteral:
    return "FractionPiLiteral";
  case NK_Expr_Measure:
    return "MeasureExpr";
  case NK_Expr_All:
    return "AllExpr";
  case NK_Expr_Parameter:
    return "ParameterExpr";
  case NK_Expr_BinaryOp:
    return "BinaryOpExpr";
  case NK_Expr_MinusOp:
    return "MinusOpExpr";
  case NK_Root:
    return "RootNode";
  default:
...
std::ostream& ParameterDeclExpr::print(std::ostream& os) const {
  ...
  utils::printSpanWithPrinterNoBracket(
      os, parameters, [](std::ostream& os, IdentifierExpr* param) {
        param->print(os);
      });
  return os << ")";
}
